...
if False:
    ...
    show_cog(ax1, ax2, ax3, ax4, s, r, max_cog_radius=10.)
    f.tight_layout()
...
def draw_line(ax, wl, label):
    ...
    ax.plot([wl]*2,[ymin,ymax], c='grey', lw=1., zorder=0)
...
def plot_spec(ax1, ax2, ww, csout, nsout, wldetect, jj, results, r, s, bad = [[5275.,5325.]]):
    ...
    if not layoutmode:
        #ax2.fill_between(ww[z1:z2], 5.*mm[z1:z2]*sqrt_bin_size, -5.*mm[z1:z2]*sqrt_bin_size,alpha=0.2, edgecolor='black', facecolor='grey')
        ...
        #ax2.fill_between(ww[z1:z2], mm[z1:z2]*sqrt_bin_size, -mm[z1:z2]*sqrt_bin_size,alpha=0.2, edgecolor='black', facecolor='grey')
